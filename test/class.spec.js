...
describe("[web] useDefineForClassFields: true (default)", function() {
	...
	testFixture({
		...
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-1-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-3-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-4-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-5-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-1-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-3-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-4-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-5-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-1-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-3-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-4-define-true.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-5-define-true.js"],
...
describe("[web] useDefineForClassFields: false (legacy)", function() {
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-1-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-2-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-3-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-4-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-1-variant-5-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-1-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-2-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-3-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-4-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-2-variant-5-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-1-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-2-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-3-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-4-define-false.js"],
	...
	testFixture({
		...
		sourceFiles: ["package.json", "tsconfig.json", "webpack.config.js", "src/application.ts"],
		tscFiles: ["lib/application.js", "lib/application.js.map"],
		webpackFiles: ["dist/index.html", "dist/app-class-3-variant-5-define-false.js"],
