...
describe('[web] useDefineForClassFields: true (default)', function(){
	// Class 1
	testFixture({
		id: 'web-class-1-variant-1-define-true',
	...
	testFixture({
		id: 'web-class-1-variant-2-define-true',
	...
	testFixture({
		id: 'web-class-1-variant-3-define-true',
	...
	testFixture({
		id: 'web-class-1-variant-4-define-true',
	...
	testFixture({
		id: 'web-class-1-variant-5-define-true',
	...
	// Class 2
	testFixture({
		id: 'web-class-2-variant-1-define-true',
	...
	testFixture({
		id: 'web-class-2-variant-2-define-true',
	...
	testFixture({
		id: 'web-class-2-variant-3-define-true',
	...
	testFixture({
		id: 'web-class-2-variant-4-define-true',
	...
	testFixture({
		id: 'web-class-2-variant-5-define-true',
	...
	// Class 3
	testFixture({
		id: 'web-class-3-variant-1-define-true',
	...
	testFixture({
		id: 'web-class-3-variant-2-define-true',
	...
	testFixture({
		id: 'web-class-3-variant-3-define-true',
	...
	testFixture({
		id: 'web-class-3-variant-4-define-true',
	...
	testFixture({
		id: 'web-class-3-variant-5-define-true',
...
describe('[web] useDefineForClassFields: false (legacy)', function(){
	// Class 1
	testFixture({
		id: 'web-class-1-variant-1-define-false',
		title: 'Class 1 - Variant 1',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-1-variant-2-define-false',
		title: 'Class 1 - Variant 2',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-1-variant-3-define-false',
		title: 'Class 1 - Variant 3',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-1-variant-4-define-false',
		title: 'Class 1 - Variant 4',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-1-variant-5-define-false',
		title: 'Class 1 - Variant 5',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	// Class 2
	testFixture({
		id: 'web-class-2-variant-1-define-false',
		title: 'Class 2 - Variant 1',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-2-variant-2-define-false',
		title: 'Class 2 - Variant 2',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-2-variant-3-define-false',
		title: 'Class 2 - Variant 3',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-2-variant-4-define-false',
		title: 'Class 2 - Variant 4',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-2-variant-5-define-false',
		title: 'Class 2 - Variant 5',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	// Class 3
	testFixture({
		id: 'web-class-3-variant-1-define-false',
		title: 'Class 3 - Variant 1',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-3-variant-2-define-false',
		title: 'Class 3 - Variant 2',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-3-variant-3-define-false',
		title: 'Class 3 - Variant 3',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-3-variant-4-define-false',
		title: 'Class 3 - Variant 4',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
	...
	testFixture({
		id: 'web-class-3-variant-5-define-false',
		title: 'Class 2 - Variant 5',
		sourceFiles: [
			'package.json',
			'tsconfig.json',
